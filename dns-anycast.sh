...
vtysh -c 'conf t' -c 'ip router-id 10.0.0.1' -c 'router bgp 64513' -c 'no bgp ebgp-requires-policy' -c 'no bgp network import-check' -c 'neighbor 10.100.100.1 remote-as 263537' -c 'neighbor 2001:db8:8000:cafe::1 remote-as 263537' -c 'address-family ipv4 unicast' -c 'network 10.200.200.12/32' -c 'network 10.200.200.13/32' -c 'neighbor 10.100.100.1 route-map IMPORT in' -c 'neighbor 10.100.100.1 route-map EXPORT out' -c 'exit-address-family' -c 'address-family ipv6' -c 'network 2001:db8:8000::12/128' -c 'network 2001:db8:8000::12/128' -c 'neighbor 2001:db8:8000:cafe::1 activate' -c 'neighbor 2001:db8:8000:cafe::1 route-map IMPORT in' -c 'neighbor 2001:db8:8000:cafe::1 route-map EXPORT-V6 out'  -c 'exit-address-family' -c 'exit' -c 'ip prefix-list RECURSIVO seq 5 permit 10.200.200.12/32' -c 'ip prefix-list RECURSIVO seq 6 permit 10.200.200.13/32' -c 'ipv6 prefix-list RECURSIVO seq 5 permit 2001:db8:8000::12/128' -c 'ipv6 prefix-list RECURSIVO seq 10 permit 2001:db8:8000::13/128' -c 'route-map EXPORT permit 10' -c 'match ip address prefix-list RECURSIVO' -c 'exit' -c 'route-map EXPORT deny 1000' -c 'route-map EXPORT-V6 permit 10' -c 'match ipv6 address prefix-list RECURSIVO' -c 'exit' -c 'route-map EXPORT-V6 deny 1000' -c 'exit' -c 'route-map IMPORT deny 1000' -c  -c 'exit' -c 'end' -c 'wr'
